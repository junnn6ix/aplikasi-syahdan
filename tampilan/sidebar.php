      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li>
                <a href="dashboard.php" class="nav-link"><i class="fas fa-fire"></i><span>DADHBOARD</span></a>
              </li>
              <li class="menu-header">Data</li>
              <li><a class="nav-link" href="spp.php"><i class="fas fa-database"></i> <span>DATA SYAHRIAH</span></a></li>
              ...
              <li><a class="nav-link" href="siswa.php"><i class="fas fa-user-graduate"></i> <span>SANTRI</span></a></li>
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li><a class="nav-link" href="kelas copy.php"><i class="fas fa-database"></i> <span>DATA KELAS</span></a></li>
              <li class="menu-header">Personal</li>
              <li><a class="nav-link" href="siswa copy.php"><i class="fas fa-user-graduate"></i> <span>SANTRI</span></a></li>
              <li class="menu-header">Fitur</li>
              <li><a class="nav-link" href="transaksi.php"><i class="fas fa-money-check-alt"></i> <span>TRANSAKSI PEMBAYARAN</span></a></li>
