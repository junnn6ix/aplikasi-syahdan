                      ...
                      <table class="table table-striped ">
                       <thead>
                        ...
                        <tr>  
                          ...
                          <td>
                          <a href="edit_siswa.php?id=<?php echo $row['nis']; ?>"class="btn btn-primary"><i class="fas fa-edit"></i></a>
                          <a href="proses_hapussiswa.php?id=<?php echo $row['nis']; ?>" class="btn btn-danger" onClick="return confirm('Anda yakin akan menghapus data ini?')"><i class="fas fa-trash"></i></a>
                          </td>
                        </tr>
                         <?php
