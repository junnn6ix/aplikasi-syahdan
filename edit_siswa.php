                  ...
                  <div class="card-body bg-primary">
                    ...
                    <form class="wizard-content mt-2" method="post" action="proses_editsiswa.php">
                      <div class="wizard-pane">
                         <input name="id" value="<?php echo $data['nis']; ?>" hidden />
                         <div class="form-group row align-items-center">
                          <label class="col-md-4 text-md-right text-white">NIS</label>
                          <div class="col-lg-4 col-md-6">
                            <input name="nis" value="<?php echo $data['nis']; ?>"  disabled="" />
                          </div>
                        </div> 
                        <div class="form-group row align-items-center">
                          <label class="col-md-4 text-md-right text-white">KOBONG</label>
                          <div class="col-lg-4 col-md-6">
                            <input type="text" name="kobong" value="<?php echo $data['kobong']; ?>" disabled="disabled"/>
                          </div>
                        </div>
                        <div class="form-group row align-items-center">
